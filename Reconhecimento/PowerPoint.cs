    ...
    public static class PowerPoint
    {
        ...
        public static void executarComandoPowerPoint(string cmd)
        {
         ...
         private static void avancarSlide()
         {
             ...
             frm.Show();
             Principal.ppt.Presentations[1].SlideShowWindow.View.Next();
         }
         ...
         private static void play()
         {
             ...
             try
             {
                 ...
                 Principal.ppt.Presentations.Open("C:\\Users\\Ricardo\\Documents\\teste.ppt", Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoFalse);
         ...
         private static void voltarSlide()
         {
             ...
             frm.Show();
             Principal.ppt.Presentations[1].SlideShowWindow.View.Previous();
         }
